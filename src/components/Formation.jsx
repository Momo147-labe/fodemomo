      ...
      <div className="container-custom">
        ...
        <AnimatedSection>
          ...
          <div className="relative">
            {/* Ligne verticale */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-400 via-primary-500 to-transparent"></div>
              ...
              {data.formation.map((formation, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center shadow-glow">
                  ...
                  {/* Carte de formation */}
                  <motion.div 
                    className="flex-1 card-modern group overflow-hidden"
                    whileHover={{ y: -5 }}
                  ...
                  >
                    <div className="grid md:grid-cols-3 gap-6 items-center">
                      ...
                      <div className="md:col-span-2 space-y-4">
                        {/* Badge de date */}
                        <div className="inline-flex items-center gap-2 bg-primary-400/10 text-primary-400 px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        <div className="flex items-center gap-2 text-dark-text-secondary">
                          ...
                          <span className="font-medium">{formation.organisateur}</span>
                        </div>
                        ...
                        <div className="inline-flex items-center gap-2 bg-green-400/10 text-green-400 px-3 py-1 rounded-full text-sm font-medium">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="relative group/cert">
                        <div className="relative overflow-hidden rounded-xl border-2 border-white/10 group-hover/cert:border-primary-400/50 transition-all duration-300">
                          <img 
                            ...
                            className="w-full h-48 object-cover group-hover/cert:scale-110 transition-transform duration-500"
                          />
                          ...
                          <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover/cert:opacity-100 transition-opacity duration-300">
